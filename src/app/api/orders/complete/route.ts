/**
 * Order Completion API - Connects to processOrderCompletion function
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Forward request to order completion function
    const response = await fetch(`${FUNCTIONS_URL}/processOrderCompletion`, {
      method: 'POST',
      headers: {
