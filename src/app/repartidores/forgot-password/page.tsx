  ...
  const handleSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const response = await fetch('/api/auth/custom-password-reset', {
        ...
        body: JSON.stringify({ 
          email: values.email,
          portal: 'repartidores' // Corrected from 'drivers'
        }),
      });
                  ...
                  <FormItem>
                    ...
                    <div className="mt-1">
                      <Input
                        {...field}
                        type="email"
                        placeholder="repartidor@befastapp.com.mx"
                        disabled={isLoading}
            ...
            <div className="text-center space-y-2">
              <p className="text-sm text-gray-400">
                ...
                <Link
                  ...
                  className="font-medium text-green-400 hover:text-green-300 transition-colors hover:underline"
                >
                  Inicia sesión aquí
                </Link>
              </p>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-sm">
            <a
              ...
              className="hover:underline transition-colors text-green-400 hover:text-green-300"
            >
