...
// Componente hijo que usa useSearchParams, envuelto en Suspense por el padre
function ResetPasswordInner() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 bg-gradient-to-br from-green-50 to-emerald-100">
      <Card className="w-full max-w-md shadow-2xl border-0 shadow-emerald-300/60">
...
export default function RepartidoresResetPasswordPage() {
  return (
    <Suspense
      fallback={
